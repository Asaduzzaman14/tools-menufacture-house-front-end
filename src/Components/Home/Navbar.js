...
const Navbar = () => {
  ...
  const menuItem = (
    <>
      <li>
        <Link className='rounded-lg text-xl' to='/home'>
          Home
        </Link>
      </li>
      <li>
      ...
      <li>
        <Link className='rounded-lg text-xl' to='/blogs'>
          Blogs
        </Link>
      </li>
      ...
      <li>
        {user ? (
          <>
            ...
            <button
              onClick={logout}
              className='btn btn-ghost text-xl rounded-lg px-2'
            >
              Sign out
            </button>
          </>
  ...
  return (
    <div className='navbar  z-10 bg-[#000]'>
      <div className='navbar-start'>
        <div className='dropdown'>
          ...
          <ul
            tabIndex='0'
            className='menu menu-compact dropdown-content mt-3 p-2 shadow-lg bg-primary text-white rounded-box w-52'
          >
            {menuItem}
          </ul>
        </div>
